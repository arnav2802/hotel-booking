        ...
        <div className='py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32'>
            ...
            <div className='mt-4'>
                ...
                <div className="flex items-center text-gray-500 mt-2">
                    ...
                    <span className='ml-2'>{room.hotel.address}</span>
                </div>
            </div>
            ...
            <form className='flex flex-col md:flex-row items-start md:items-center justify-between bg-white shadow-[0px_0px_20px_rgba(0,0,0,0.15)] p-6 rounded-xl mx-auto mt-16 max-w-6xl'>
                <div
                    className='flex flex-col fldx-wrap md:flex-row items-start md:items-center gap-4 md:gap-10 text-gray-500'>
                    ...
                    <div className='flex flex-col'>
                        ...
                        <input type='date' id='checkOutDate' placeholder='Check-In'
                               className='w-full rounded border border-gray-300 px-3 py-2 mt-1.5 outline-none'
                               required=''/>
                    </div>
                    <div className=' w-px h-15 bg-gray-300/70 max-md:hidden'>
                ...
                <button type='submit'
                        className='bg-primary hover:bg-primary-dull active:scale-95 transition-all text-white rounded-md max-md:w-full max-md:,t-6 md:px-25 py-3 md:py-4 text-base cursor-pointer'>
                    Check Availability
                </button>
            </form>
