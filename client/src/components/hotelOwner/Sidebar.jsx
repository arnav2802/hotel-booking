...
import { assets as assests } from "../../assets/assets.js";

const Sidebar = () => {

    const sidebarLinks = [
        {
            name: 'Dashboard', path: '/owner', icon: assests.dashboardIcon,
        },
        {
            name: 'Add Room', path: '/owner/add-room', icon: assests.addIcon,
        },
        {
            name: 'List Room', path: '/owner/list-room', icon: assests.listIcon,
        }
    ];
